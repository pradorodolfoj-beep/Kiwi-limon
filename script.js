...
function updateCartUI() {
    ...
    // Si aún no ha elegido opción, mantener el formulario oculto
...
function selectDeliveryOption(option) {
    ...
    // 1. Mostrar el formulario con animación/display flex al pulsar una opción
    if (customerDataForm) {
        customerDataForm.style.setProperty("display", "flex", "important");
    }

    // 2. Controlar estado de botones y visibilidad del campo de Dirección
    if (option === 'pickup') {
        if (pckBtn) {
            pckBtn.style.backgroundColor = "var(--accent-limon, #d4ff00)";
            pckBtn.style.color = "#000";
        }
        if (delBtn) {
        ...
        if (delBtn) {
            delBtn.style.backgroundColor = "var(--accent-limon, #d4ff00)";
            delBtn.style.color = "#000";
        }
        if (pckBtn) {
            pckBtn.style.backgroundColor = "";
            pckBtn.style.color = "";
        }
